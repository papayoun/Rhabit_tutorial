...
One can see that the firt two coefficients have higher values than the third one. 
...
Following the previous codes, fit the Langevin Movement model using this new set of covariates.

Check again the estimates of the $\beta$ coefficients.
Using the AIC, choose the best model.
